...
using PowerUps.MicroServices.LogEnricher.Setup;

namespace PowerUps.MicroServices.LogEnricher
{
    class Program
    {
        static int Main(string[] args)
        {
            return SelfhostServiceInitializer.Run<IMicroServicesCoreConfiguration>(
        ...
        {
            return MicroServiecsDefaults.CreateBlocksOptions(
