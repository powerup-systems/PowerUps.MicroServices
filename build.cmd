...
powershell -Command "if ((Test-Path 'Source\Solutions\.nuget\NuGet.exe') -eq $false) {(New-Object System.Net.WebClient).DownloadFile('http://nuget.org/nuget.exe', 'Source\.nuget\NuGet.exe')}"
